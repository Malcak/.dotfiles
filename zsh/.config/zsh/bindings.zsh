...
bindkey -- "${keys[Ctrl+Shift+Left]}"       .beginning-of-line
bindkey -- "${keys[Ctrl+Shift+Right]}"      .end-of-line
bindkey -- "${keys[Alt+Shift+Left]}"        .beginning-of-line
bindkey -- "${keys[Alt+Shift+Right]}"       .end-of-line

bindkey -- "${keys[Ctrl+Backspace]}"        .backward-kill-word
bindkey -- "${keys[Ctrl+Delete]}"           .kill-word
bindkey -- "${keys[Alt+Backspace]}"         .backward-kill-word
bindkey -- "${keys[Alt+Delete]}"            .kill-word

# No special codes for every combination of backspace
# bindkey -- "${keys[Alt+Shift+Backspace]}"   .backward-kill-line
# bindkey -- "${keys[Alt+Shift+Delete]}"      .kill-line
